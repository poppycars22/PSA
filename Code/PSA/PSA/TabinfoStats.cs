...
namespace PSA
{
    public class TabinfoInterface
    {
        public static void Setup()
        {
            ...
            TabInfoManager.RegisterStat(ExtraStats, "Damage Multiplier", (p) => p.data.stats.GetAdditionalData().damageReduction < 1f, (p) => string.Format("{0:F0}%", (1 - p.data.stats.GetAdditionalData().damageReduction) * 100));
